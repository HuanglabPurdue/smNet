...
from .loss import L1Loss, NLLLoss, KLDivLoss, MSELoss, CRLBMSELoss, BCELoss, BCEWithLogitsLoss, NLLLoss2d, \
...
__all__ = [
    ...
    'Tanhshrink', 'RReLU', 'L1Loss', 'NLLLoss', 'KLDivLoss', 'MSELoss', 'CRLBMSELoss', 'BCELoss', 'BCEWithLogitsLoss',
