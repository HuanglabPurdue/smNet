...
classdef OptimPR_Ast < handle
    % OptimPR_Ast class for optimizing PR result that will be used for 3D
    % localization based on Astigmatism method. 
    %   create object: obj = OptimPR_Ast();
    %
    % OptimPR_Ast Properties (Implemented object):
    %   OTFobj - 
    %   PRobj - 
    %
    % OptimPR_Ast Properties (Input):
    %   FileDir - 
    %   FileName - 
    %   FitType - 
    %   FitZrange - 
